...
def process(n_iter,
    ...
    background_w, background_h = background_img.shape[0:2]
    background_verticies = (
        (-4, -4 * background_w / background_h, -0.01),  # 0
        (-4, 4 * background_w / background_h, -0.01),  # 1
        (4, 4 * background_w / background_h, -0.01),  # 2
        (4, -4 * background_w / background_h, -0.01),  # 3
    )
    ...
    draw_rect(background_verticies, normals, surfaces)
